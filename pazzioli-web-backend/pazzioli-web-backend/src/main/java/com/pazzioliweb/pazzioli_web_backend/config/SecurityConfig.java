package com.pazzioliweb.pazzioli_web_backend.config;
...
import com.pazzioliweb.pazzioli_web_backend.filtros.JwtRequestFilter;
...
public class SecurityConfig {
	  @Autowired
	 private JwtRequestFilter filtro ;
    @Bean
