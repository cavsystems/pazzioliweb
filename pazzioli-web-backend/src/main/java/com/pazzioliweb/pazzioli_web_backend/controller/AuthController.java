...
import com.pazzioliweb.pazzioli_web_backend.repository.SessionRepository;
import com.pazzioliweb.pazzioli_web_backend.repository.UsuarioRepository;
import com.pazzioliweb.pazzioli_web_backend.utiljava.JwtUtilJava;
...
public class AuthController {
  ...
  private final   HttpServletResponse servletResponse;
    @Autowired
    public AuthController(UsuarioRepository usuarioRepository, SessionRepository sessionRepositorio,JwtUtilJava jwtUtil, HttpServletResponse servletResponse) {
    ...
    public void crearSesion(long codigo) {
