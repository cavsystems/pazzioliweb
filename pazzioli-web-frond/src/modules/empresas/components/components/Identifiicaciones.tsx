...
...rest}: any) {
    return ( 
        <>
           <div className="col-12">
                ...
                <h6  className="titlecamposempresa h6" style={{padding:'30px 10px 10px 0 '}}>Identificación</h6>
               <div>
                <div className="row">
  ...
  />
   <CFormLabel htmlFor="identificacion">Numero de identificacion</CFormLabel>
  </CFormFloating>
            </CInputGroup>
            </div>
 ...
 <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
  ...
  <CFormSelect
    size="lg"
    placeholder="Tipo de identitificacion"
    className="inputselect fontletre"
  ...
  <CFormLabel>Tipo de persona</CFormLabel>
    ...
    <CFormLabel htmlFor="digitodeverificacion">Digito de verificacion</CFormLabel>
              </CFormFloating>
            </CInputGroup>
            </div>
